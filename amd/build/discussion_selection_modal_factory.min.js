define("mod_kialo/discussion_selection_modal_factory",["exports","core/modal_factory","core/str","./deeplink_setup_modal"],(function(_exports,_modal_factory,_str,_deeplink_setup_modal){var obj;
/**
   ...
   */Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.init=void 0,_modal_factory=(obj=_modal_factory)&&obj.__esModule?obj:{default:obj};_exports.init=async deeplinkUrl=>{await(0,_deeplink_setup_modal.setupModal)(_modal_factory.default.create.bind(_modal_factory.default),await(0,_str.get_string)("select_discussion","mod_kialo"),deeplinkUrl)}}));

//# sourceMappingURL=discussion_selection_modal_factory.min.js.map